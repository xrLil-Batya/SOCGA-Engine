...
class_<CScriptGameObject> script_register_game_object2(class_<CScriptGameObject>&& instance)
{
    return std::move(instance)
        ...
        .def("best_cover",
             (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, const Fvector&, float, float, float, const luabind::functor<bool>&))(&CScriptGameObject::best_cover))
        .def("safe_cover", (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, float, float))(&CScriptGameObject::safe_cover))
        .def("safe_cover", (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, float, float, const luabind::functor<bool>&))(&CScriptGameObject::safe_cover))
        .def("ambush_cover", (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, const Fvector&, float, float))(&CScriptGameObject::ambush_cover))
        .def("ambush_cover",
             (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, const Fvector&, float, float, const luabind::functor<bool>&))(&CScriptGameObject::ambush_cover))
        .def("angle_cover", (const CCoverPoint* (CScriptGameObject::*)(const Fvector&, float, const Fvector&, float, float, u32))(&CScriptGameObject::angle_cover))
        .def("angle_cover",
        ...
        .def("Actor_HasPNV", &CScriptGameObject::Actor_HasPNV)
        .def("Actor_HasTorch", &CScriptGameObject::Actor_HasTorch)
