...
void ShowHudEditor(bool& show)
{
	...
	if (item)
	{
        ...
        ImGui::Separator();
        ImGui::InputFloat3("fire_point 0", (float*)&item->m_measures.m_fire_point_offset, 3);
        ImGui::InputFloat3("fire_point2 0", (float*)&item->m_measures.m_fire_point2_offset, 3);
        ImGui::InputFloat3("shell_point 0", (float*)&item->m_measures.m_shell_point_offset, 3);
		if (const auto Wpn = smart_cast<CWeapon*>(item->m_parent_hud_item))
		{
			ImGui::Separator();
			ImGui::InputFloat3("laserdot_attach_offset 0", (float*)&Wpn->laserdot_attach_offset, 3);
			ImGui::InputFloat3("torch_attach_offset 0", (float*)&Wpn->flashlight_attach_offset, 3);
		}
	}
